...
insert into Items (itemName, description, price)(itemName, description, price) values ('Miley Cyrus Värdighet', 'Den må vara liten eller knappt existerande, men det går ryckten om att den en gång i tiden betyde något.', 80085);
